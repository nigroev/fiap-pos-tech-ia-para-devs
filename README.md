...
**Repositório do curso _Pós Tech: IA para Devs_ — FIAP (turma 8IADT)** 🎓🤖
...
- Caso haja dúvidas sobre conteúdo ou execução, consulte os materiais da disciplina ou os instrutores.

---

**Turma:** 8IADT | **Curso:** Pós Tech IA para Devs — FIAP
